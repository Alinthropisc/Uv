...
/// Timeout is the time uv should wait before declaring a port closed. As datatype Duration.
/// greppable is whether or not uv should print things, or wait until the end to print only the ip and open ports.
...
impl Scanner {
    ...
    /// If you want to run uv normally, this is the entry point used
